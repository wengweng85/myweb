...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="<c:url value='/resource/hplus/css/bootstrap.min.css'/>" rel="stylesheet">
...
<body class="gray-bg">
    ...
    <script src="<c:url value='/resource/hplus/js/welcome.min.js'/>"></script>
</body>
